...
private:
	...
	/* Print implementation of str() method for class "clazz" to "os",
	...
	/* Check if we can support the generator of constructor "cons".
	 */
	bool is_supported_constructor(FunctionDecl *cons);
};
